...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement("p", null, this.props.listLabel), React.createElement("div", {
      className: "oc-hierarchy-selector-selected-items"
    },React.createElement( React.Fragment , null , checkedItemsHashLists.map(function (list) {
