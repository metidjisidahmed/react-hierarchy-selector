...
import { FaCheckSquare, FaRegCheckSquare, FaRegSquare , FaCalendarCheck } from 'react-icons/fa';
  ...
  function ItemCheckbox(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getIcon", function () {
      ...
      if (_this.state.checked) {
        ...
        console.log('CREATING THE CHECKBOX FOR THE PARENTS');
        icon =React.createElement( FaRegSquare, null);
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "clickHandler", function (e) {
      console.log("I'm CHECKING !" , _this);
      console.log("disabled : ", _this.props.disabled);
      console.log("checked :", _this.state.checked);
      if(_this.state.checked && _this.props.disabled){
          console.log("I'm in the case where teh parent is unchecked");
          console.log('State= ', _this.state ,' and the props : ', _this.props);
          _this.props.onCheckAll(e);
      }
      // Check all for the parent
      else if(!_this.state.checked && _this.props.disabled){
        _this.props.onCheckAll(e);
      }
