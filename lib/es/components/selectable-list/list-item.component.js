...
function (_React$Component) {
  ...
  function ListItem() {
    ...
    _defineProperty(_assertThisInitialized(_this), "clickHandler", function (event) {
        // console.log('I CLICKED IN THE LIST ITEM ! ES')
      // setTimeout(()=>{

      // },10)
      _this.props.onClick(_this.props.item.id, event);
      // setTimeout(()=>{
      //   document.querySelectorAll('.oc-selectable-list-item')
      //       .forEach((elem)=>{
      //         console.log('ELEM =' , elem)
      //         elem.addEventListener('click', ()=>{
      //           console.log('CLICKED !');
      //           let div=elem;
      //           while(!div.classList.contains('oc-hierarchy-selector-column')){
      //             div=div.parentElement;
      //             console.log('Actual DIV =', div);
      //           }
      //           // let xPositionParent= div.offsetLeft;
      //           // console.log('Position parent =', xPositionParent);
      //           let xPositionSibling =null;
      //           if(div.nextSibling!=null){
      //             xPositionSibling=div.nextSibling.offsetLeft;
      //           }
      //           console.log('Position Sibling =', xPositionSibling);
      //           while(div.previousSibling) {
      //             div = div.previousSibling;
      //           }
      //           let xPositionFirstParent= div.offsetLeft;
      //           console.log('Position parent =', xPositionFirstParent);
      //
      //           if(xPositionSibling){
      //             let scrollContainer=document.querySelector('.oc-hierarchy-selector-tab-content');
      //             scrollContainer.scrollTo({
      //               behavior : 'smooth',
      //               left : xPositionSibling-xPositionFirstParent
      //             })
      //           }
      //
      //
    ...
    _defineProperty(_assertThisInitialized(_this), "checkHandler", function (checkState) {
      console.log('Check State in List Item Compounent =', checkState);
